...
function viewGrade() {
    ...
    cellHeadReg.innerHTML = "<b>" + "Reg-No" + "</b>"
    let cellSname = row.insertCell();
    cellSname.innerHTML = "<b>" + "Name" + "</b>"
    let cellTscore = row.insertCell();
    cellTscore.innerHTML = "<b>" + "Test" + "</b>"
    let cellEscore = row.insertCell();
    cellEscore.innerHTML = "<b>" + "Exam" + "</b>"
    let cellTotalscore = row.insertCell();
    cellTotalscore.innerHTML = "<b>" + "Total" + "</b>"
